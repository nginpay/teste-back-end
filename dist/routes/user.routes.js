...
(0, typeorm_1.createConnection)().then(function (connection) {
    ...
    usersRouter.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, email, senha, user, error_1, token;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    token = jwt.sign({ userId: user.id, username: user.nome }, config_1.default.jwtSecret, { expiresIn: "1h" });
    ...
    usersRouter.get("/profile/:id", [checkJwt_1.checkJwt], function (req, res) {
    ...
    usersRouter.put("/profile/:id", function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var user, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
